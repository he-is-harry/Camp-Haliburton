...
public class ImagePixelator {
    ...
    public static void main(String[] args) {
        try {
            // Upload the image
            BufferedImage image = ImageIO.read(new File("raw/ExclamationMark.png"));
            int width = image.getWidth();
            int height = image.getHeight();
//            int[] pixels = new int[width * height];
            int pixelationStrength = 16;
...
//                		}
            ...
            ImageIO.write(bufferedImage, "png", new File("zoutput/pixelated.png"));
